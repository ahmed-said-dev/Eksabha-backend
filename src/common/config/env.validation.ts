...
export const envValidationSchema = Joi.object({
  ...
  EXTERNAL_FEED_PROVIDER: Joi.string().valid('api-football').allow('').default('api-football'),
  ...
  EXTERNAL_FEED_AUTO_SYNC_ENABLED: Joi.boolean().truthy('true').falsy('false').allow('').default(false),
  EXTERNAL_FEED_SYNC_INTERVAL_SECONDS: Joi.number().integer().min(15).default(30),
  EXTERNAL_FEED_AUTO_SYNC_ON_BOOT: Joi.boolean().truthy('true').falsy('false').allow('').default(true),
